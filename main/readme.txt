...
All configuration except for logging is done through a spring config file
located "config/spring.xml".

The used can be configured by adding an attribute in run.xml
